  ...
  <div>
    ...
    <div style="margin-top: 80px">
      ...
      <div style="height: calc(100vh - 80px); overflow-y: scroll" class="pt-4">
        <div class="row mx-4">
          <h3 class="col">Detalle de Nota de Venta</h3>
        </div>
        <div class="row mx-4 mt-4">
          <h5 class="col">Información Personal del Cliente</h5>
        </div>
        <div class="row mx-4">
          <input
            type="text"
              ...
              <div class="form-row">
                <div class="form-group col-6">
                  ...
                  <input
                    type="text"
                    class="form-control"
                    v-model="nota_venta.nom_vendedor"
                    disabled
                  />
                </div>
                <div class="form-group col-6">
              ...
              <div class="form-row">
                <div class="form-group col-3">
                  ...
                  <input
                    type="text"
                    class="form-control"
                    v-model="nota_venta.nombre_cliente"
                    :disabled="tipo == 'ver'"
                  />
                </div>
                <div class="form-group col-3">
                  ...
                  <select
                    name="select"
                    class="form-control"
                    v-model="nota_venta.tipoDocumento"
                    :disabled="tipo == 'ver'"
                  >
                    <option
                ...
                <div class="form-group col-3">
                  ...
                  <input
                    type="text"
                    class="form-control"
                    v-model="nota_venta.num_documento"
                    :disabled="tipo == 'ver'"
                  />
                </div>
                <div class="form-group col-3">
        ...
        <div class="row mx-4 mt-4">
          <h5 class="col">Información de Productos</h5>
        </div>
        <div class="mx-4">
          <table class="table">
            <thead>
              ...
              <tr v-for="usuario in listaProducto" :key="usuario.nomProducto">
                ...
                <td v-else>
                  <input
                    ...
                    id=""
                    class="form-control"
                    v-model="usuario.cantidad"
                    min="1"
                    :max="usuario.stock"
                  />
                </td>
                <td v-if="tipo == 'ver'">
                  S/.{{ usuario.PrecioTotal.toFixed(2) }}
                </td>
                <td v-else>
                  S/.{{ Number(usuario.precio * usuario.cantidad).toFixed(2) }}
                </td>
                <td></td>
                <td scope="col" v-if="tipo != 'ver'">
                  <div
                    ...
                    @click="deleteProduct(usuario.id_producto)"
                  >
            ...
            <div class="card-body">
              ...
              <div class="form-row justify-content-end">
                <div class="form-group col-3 mt-2">
                  <input
                    type="button"
                    class="btn btn-info btn-block mt-4 my-1 form-group col-12 btnguarda-registro"
              ...
              <div class="modal-body">
                <div class="form-group">
                  <label for="exampleInputPassword1"
                    >Esto es combobox(Efectivo / Yape)..NO OLVIDAR XD</label
                  >
                  <input
                    type="text"
                    class="form-control"
          ...
          >
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button
                  type="button"
                  class="btn btn-info my-1 btnguarda-registro"
  ...
  methods: {
    confirmDelete() {
      ...
      this.listaProducto = this.listaProducto.filter(
        (p) => p.id_producto != this.productoEliminar
      );
    ...
    async getTipoDocumentos() {
      let response = await axios.get(
        "api/cmbTipoDoc?token=" + usuario.getData().token
      );
    ...
    isUncomplete() {
      let campos = Object.keys(this.nota_venta);
      return (
        campos.some((input) => !this.nota_venta[input]) ||
      ...
      if (!this.isUncomplete()) {
        const body = {
          ...
          listProduct: JSON.stringify(
            this.listaProducto.map(function (producto) {
              return {
        ...
        let response = await axios.post("api/updateNV", body);
