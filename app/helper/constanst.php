...
$_SESSION["DATA_BASE"] = "dulcekat";  //NOMBRE DE LA BASE DE DATOS // NO PUSHEAR ESTO MRD :V

//STATUS DE PETICIONES
$_SESSION["STATUS_SUCCES"] = "0"; // PETICION CORRECTA
$_SESSION["STATUS_CONTROL"] = "1"; // ERROR DE FRONT 
$_SESSION["STATUS_ERROR"] = "2"; // ERROR DE BACK
